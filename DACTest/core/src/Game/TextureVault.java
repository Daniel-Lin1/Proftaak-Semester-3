...
public class TextureVault {
    ...
    public final static Texture knight75 = new Texture(Gdx.files.internal("assets/Knight75.png"));
    public final static Texture knight50 = new Texture(Gdx.files.internal("assets/Knight50.png"));
